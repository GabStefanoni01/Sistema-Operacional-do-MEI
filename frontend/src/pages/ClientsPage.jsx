  ...
  return (
    <div className="page-container fade-in">
      ...
      <div className="page-header">
        <h2><i className="fa-solid fa-address-book" /> Gerenciamento de Clientes</h2>
        <p className="text-secondary">Adicione, edite e acompanhe sua base de clientes.</p>
      </div>
        ...
        <section className="list-section">
          <div className="card">
            <div className="list-header">
              <h2><i className="fa-solid fa-users" /> Meus Clientes</h2>
